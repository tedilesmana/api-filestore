...
{
    protected $gatewayApplicationRepository;
    public function __construct(GatewayApplicationRepositoryInterface $gatewayApplicationRepository)
    {
        $this->gatewayApplicationRepository = $gatewayApplicationRepository;
    }
