...
namespace App\Http\Controllers\Api\AdditionalMenu;
...
class AdditionalMenuController extends BaseController
{
    protected $eloquentRepository;
    public function __construct(AdditionalMenuRepositoryInterface $eloquentRepository)
    {
