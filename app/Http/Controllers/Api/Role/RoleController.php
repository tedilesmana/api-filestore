...
class RoleController extends BaseController
{
    ...
    public function __construct(RoleRepositoryInterface $eloquentRepository)
    {
    ...
    {
        try {
            $response = $this->eloquentRepository->addRoleUser($request); 
            if ($response->success) {
    ...
    {
        try {
            $response = $this->eloquentRepository->deleteRoleUser($request);
            if ($response->success) {
                return $this->successResponse($response->message, $response->data->data, $response->data->pagination);
            } else {
                return $this->errorResponse($response->message, $response->data);
