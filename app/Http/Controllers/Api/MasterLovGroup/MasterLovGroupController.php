...
namespace App\Http\Controllers\Api\MasterLovGroup;
...
class MasterLovGroupController extends BaseController
{
    protected $eloquentRepository;
    public function __construct(MasterLovGroupRepositoryInterface $eloquentRepository)
    {
